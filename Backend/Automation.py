...
classes = ["zCubwf", "hgKElc", "LTK00 sY7ric", "Z0LcW", "gsrt vk_bk FzvWSb YwPhnf", "pclqee", "tw-Data-text tw-text-small tw-ta",
           ...
           "LWkfke", "VQF4g", "qvWpe", "kno-rdesc", "SPZz6b"]

useragent = 'Mozilla/5.0(Windows NT 10.0; Wind64 ; x64) AppleWebKit/537.36 (KHTML,like Gecko) Chrome/100.0.4896.75 Safari/537.36'
...
def OpenApp(app, sess=requests.session()):
    try:
        ...
        def search_google(query):
            ...
            response = sess.get(url, headers=url)
